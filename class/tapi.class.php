...
class Tapi
{
    ...
    public function __construct(string $nazione){  
        // Ottieni i dati di connessione dal file costanti.php
        
        // Costanti::TAPI_IT()
        $datiConnessione = Costanti::{'TAPI_' . strtoupper($nazione)}();
        
        $this->host = $datiConnessione['host'];
        $this->user = $datiConnessione['user'];
        $this->pass = $datiConnessione['pass'];
        $this->dbname = $datiConnessione['dbname'];
